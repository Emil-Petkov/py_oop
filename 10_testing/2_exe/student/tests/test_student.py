...
class TestStudent(TestCase):
    ...
    def test_student_init_with_courses(self):
        courses = {"Python OOP": ["note1", "note2", "note3"]}
    ...
    def test_enroll_student_updates_course_notes_when_courses_is_already_enrolled(self):
        course_name = "Python OOP"
        courses = {course_name: ["note1", "note2", "note3"]}

        student = Student(self.STUDENT_NAME, courses)

        result = student.enroll(course_name, ["note4", "note5"])

        self.assertEqual("Course already added. Notes have been updated.", result)
        self.assertEqual(["note1", "note2", "note3", "note4", "note5"], student.courses[course_name])
    ...
    def test_enroll_student_extends_courses_with_course_without_notes_when_invalid_add_course_notes_argument_is_passed(
            self):
        course_name = "Python Advanced"
        course_notes = ["note1", "note2"]
    ...
    def test_add_notes_updates_course_notes_when_course_exists(self):
        ...
        result = student.add_notes(course_name, "note92")
        self.assertEqual("Notes have been updated", result)
        self.assertEqual(["note1", "note2", "note3", "note92"], student.courses[course_name])
    ...
    def test_leave_course_remove_course_when_student_in_enrolled_for_the_course(self):
